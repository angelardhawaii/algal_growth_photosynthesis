...
## Run5 Analysis, Script Chunks, and Plots

This is the analysis of the final run of the Ulva and Hypnea salinity and nutrient experiments conducted on the lanai in St. John 616. 
...
```{r}
run5_growth <- read.csv("data/run5_growth_all_012422.csv")
```
...
Also make a new column for daily growth rate from 8 day study (steady growth rate assumed rather than exponential), which may or may not be used
